document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log(localStorage.getItem('playerOneScore'))
    console.log(localStorage.getItem('playerTwoScore'))
    console.log(localStorage.getItem('playerOneName'))
    console.log(localStorage.getItem('playerTwoName'))
...
document.addEventListener('DOMContentLoaded', function() {
    // Retrieve user scores and dictionaries from local storage
    let player1Score = localStorage.getItem('playerOneScore');
    let player2Score = localStorage.getItem('playerTwoScore');
    let player1name = localStorage.getItem('playerOneName');
    let player2name = localStorage.getItem('playerTwoName');
    ...
    // Initialize arrays to store usernames, scores, and category percentages
    const usernames = [player1name, player2name];
    ...
    for (let category in storedDictionary1) {
        ...
        categoryPercentages[category][player1name] = (storedDictionary1[category] / totalScore1) * 100;
    }
